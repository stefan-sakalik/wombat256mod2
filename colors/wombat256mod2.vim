" Vim color file
" Modified version of wombat256mod vimscripts theme by
...
let colors_name = "wombat256mod2"


" General colors
"hi Normal		ctermfg=252		ctermbg=234		cterm=none		guifg=#e3e0d7	guibg=#242424	gui=none
hi Normal		ctermfg=252		ctermbg=233		cterm=none		guifg=#e3e0d7	guibg=#131313	gui=none
...
hi Search		ctermfg=253		ctermbg=31		cterm=none		guifg=#d787ff	guibg=#636066	gui=none
...
hi StatusLineNC	ctermfg=248		ctermbg=238		cterm=none		guifg=#857b6f	guibg=#444444	gui=none
...
hi Type			ctermfg=142		cterm=none		guifg=#d4d987	gui=none
